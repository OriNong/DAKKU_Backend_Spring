...
public class ChatService {
    ...
    public List<MessageVO> saveMsg(ChatMessageCreateCommand chatMessageCreateCommand) {
        ...
        // 메시지 테이블
        // roomId, 메시지, 작성자, 년월일
        List<MessageVO> messageList = chatMapper.messageSearch(chatMessageCreateCommand.getRoomID());
        return messageList;
    }
